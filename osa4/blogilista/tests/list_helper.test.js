...
describe('total likes', () => {
    ...
    test('vain yhden blogin tykkäykset', () => {
      const result = listHelper.totalLikes(listWithOneBlog)
      expect(result).toBe(5)
    })

    test('useamman blogin tykkäykset yhteensä', () => {
...
describe('most blogs', () => {
  ...
  const enitenBlogeja = 
    ...
    test('eniten blogeja', () => {
      ...
      expect(result).toEqual(enitenBlogeja);
    })
